  ...
  return (
    <div id="projects" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16 ">
      <a
        ...
        className="w-[50%] mb-3 flex justify-center items-center rounded-full shadow-lg text-black bg-gray-100 shadow-gray-400 m-auto min-w-[150px] p-4 cursor-pointer hover:bg-gray-800 hover:scale-105 hover:text-white ease-in duration-200"
      >
      ...
      <div className="grid sm:grid-cols-2 gap-12">
        ...
        <ProjectItems
          img={Todo}
          title="Todo App"
          link={"https://github.com/MetinIsakhanli/TodoApp-Firebase-ReactJS"}
        />
        <ProjectItems
          img={Auth}
