          ...
          <div className="text-green-400 flex flex-col gap-2 w-full p-1 md:p-10 items-center max-w-[1000px]">
            ...
            <div className="flex flex-col gap-2 w-full">
              <a
                ...
                target="_blank"
                className="bg-blue-500 flex flex-row items-center justify-start text-white hover:bg-transparent hover:text-blue-500 w-full md:max-w-[420px] ease-in duration-200 cursor-pointer text-sm md:text-lg p-2 mx-auto text-center border-[1px] border-blue-500 rounded-sm  group"
              >
                <img
                  src={Right}
              ...
              <a
                ...
                target="_blank"
                className="bg-gray-700 flex flex-row items-center justify-start text-gray-300 hover:bg-transparent hover:text-gray-400 md:max-w-[420px] ease-in duration-200 cursor-pointer text-sm md:text-lg p-2 mx-auto w-full text-center border-[1px] border-gray-700 rounded-sm  group"
              >
                <img
                  src={Right}
                  className="h-5 -translate-x-1 group-hover:translate-x-0 duration-200"
