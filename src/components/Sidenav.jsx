  ...
  return (
    <div>
      <AiOutlineMenu
        ...
        className={
          nav
            ? "fixed top-4 right-4 z-[99] md:hidden text-black  border-2 border-red-500 rounded-sm cursor-pointer"
            : "fixed cursor-pointer top-4 right-4 z-[99] md:hidden text-[#ffba08] border-2 border-red-500 rounded-sm"
        }
      />
      {nav ? (
